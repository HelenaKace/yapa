// PERX seed catalog — Albania-first, internationally architected.
...
export const PROVIDERS = [
  ...
  { id: "p_purepilates", name: "Pure Pilates", category: "wellness", city: "Tirana", emoji: "🤸", blurb: "Reformer pilates & mobility studio." },
  { id: "p_skyspa", name: "Sky Spa Tirana", category: "wellness", city: "Tirana", emoji: "💆", blurb: "Rooftop spa, sauna & massage." },
  { id: "p_mullixhiu", name: "Mullixhiu", category: "food", city: "Tirana", emoji: "🍲", blurb: "Iconic Albanian farm-to-table dining." },
  { id: "p_komiteti", name: "Komiteti Kafe-Muzeum", category: "food", city: "Tirana", emoji: "☕", blurb: "Retro café, raki & local plates." },
  { id: "p_wolt", name: "Wolt Albania", category: "food", city: "Tirana", emoji: "🛵", blurb: "Food delivery credit, citywide." },
  ...
  { id: "p_british", name: "British Council Tirana", category: "learning", city: "Tirana", emoji: "🇬🇧", blurb: "Language courses & IELTS prep." },
  ...
  { id: "p_vodafone", name: "Vodafone Albania", category: "telecom", city: "Nationwide", emoji: "📶", blurb: "Mobile data & device deals." },
  { id: "p_spar", name: "SPAR Albania", category: "retail", city: "Nationwide", emoji: "🛒", blurb: "Groceries & everyday essentials." },
