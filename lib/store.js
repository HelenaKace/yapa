...
function seedState() {
  return {
    ...
    activity: [
      { id: "a_seed1", ts: Date.now() - 1000 * 60 * 60 * 26, type: "join", text: "Klea joined PERX 🎉" },
      { id: "a_seed2", ts: Date.now() - 1000 * 60 * 60 * 5, type: "approved", text: "Redon's Riviera Escape was approved ✈️" },
    ],
