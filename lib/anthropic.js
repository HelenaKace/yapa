...
export function heuristicInsights({ stats }) {
  ...
  return {
    ...
    insights: [
      { title: "Most-loved category", detail: `${top ? top[0] : "Wellness"} leads on spend — consider adding more options there.` },
      { title: "Budget utilisation", detail: `${stats.utilisationPct || 0}% of welfare budget is committed this cycle.` },
      { title: "Quick win", detail: "Promote a seasonal package to re-engage employees who haven't picked yet." },
    ],
  };
}
