...
export function heuristicInsights({ stats }) {
  ...
  return {
    ...
    insights: [
      ...
      { title: "Approval focus", detail: pending > 0 ? `${pending} L is waiting in the queue for mock payout approval.` : "Promote a seasonal package to re-engage employees who have not picked yet." },
    ],
  };
}
